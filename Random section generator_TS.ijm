#@ int(label="Width of tiles in pixels:") tileSize
...
while(i < RoisN)
{
    ...
    {
    	makeRectangle(x1, y1, tileSize, tileSize); //this will make the dimesnions for the size of your regions, can change to fit needs)
    	roiManager("Add");
    	setResult("X", i, x1);
    	setResult("Y", i, y1);
    	v = getPixel(x1, y1);
